...
// die();
    ...
    if ( $_SERVER['REQUEST_METHOD'] == "POST" ) 
    {
        ...
        if (isset($post_clean['actors'])) {
            ...
            elseif (mb_strlen($post_clean['actors']) > 255) { // max:255
        ...
        if ( isset($post_clean['review']) ) 
        {
            ...
            {
                $create_form_errors['review'] = "La note est obligatoireeeeeeee.";
            }
        ...
        <div class="form-container">
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="actors" id="actors_film" class="form-control" value="<?php echo isset($_SESSION['old']['actors']) ? $_SESSION['old']['actors'] : ""; unset($_SESSION['old']['name']); ?>" >
                </div>
                <div class="mb-3">
                    <label for="review_film">La note sur 5</label>
                    <input type="text" name="review" id="review_film" class="form-control" value="<?php echo isset($_SESSION['old']['review']) ? $_SESSION['old']['review'] : ""; unset($_SESSION['old']['name']); ?>" >
                </div>
                <div class="mb-3">
